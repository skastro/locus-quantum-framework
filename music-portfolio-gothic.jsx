          ...
          >
            ...
            <div style={{
              ...
              <div>
                ...
                <div style={{ fontWeight: 600, color: '#FFFFFF' }}>Afro-Electronic</div>
              </div>
              <div>
                <div style={{ opacity: 0.6, marginBottom: '0.25rem' }}>BPM</div>
                <div style={{ fontWeight: 600, color: '#FFFFFF' }}>128</div>
              </div>
              <div>
                <div style={{ opacity: 0.6, marginBottom: '0.25rem' }}>Key</div>
                <div style={{ fontWeight: 600, color: '#FFFFFF' }}>E Minor</div>
              </div>
              <div>
                <div style={{ opacity: 0.6, marginBottom: '0.25rem' }}>Released</div>
                <div style={{ fontWeight: 600, color: '#FFFFFF' }}>Jan 2026</div>
              </div>
            </div>
          </motion.div>
        </div>
